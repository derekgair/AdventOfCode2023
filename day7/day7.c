...
int addrank(struct Node *rank, int *hand, int calcRank, int bid,char* desc) {
    for ( int i = 0; ; ++i) {
        if ( rank[i].rank==-1 )
        {
        ...
        for ( char* pos = line ; (*pos)!='\0'; ++pos) {
            if ( *pos == ' ')
               mode = READ_BID;
                ...
                else if ( *pos == 'T' ) addhand(hand, 10);
                else if ( *pos == 'J' ) addhand(hand, 11);
                else if ( *pos == 'Q' ) addhand(hand, 12);
                else if ( *pos == 'K' ) addhand(hand, 13);
                else if ( *pos == 'A' ) addhand(hand, 14);                
            }
